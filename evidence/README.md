...
| [Iteration 10 package smoke](iteration-10-package-smoke-local-2026-08-26.json)                  | Internal clean install of one recorded local package artifact                  | External Adapter identity chain through installed CLI/Workbench/Fork; v1→v2 store migration; lockfile-bearing source bundle frozen install/typecheck/build/374 tests                                                              | npm publication, current-revision binding, independent Adapter/operator, cross-host or production result                                                     |
