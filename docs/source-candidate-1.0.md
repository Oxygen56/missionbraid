...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Local tarball build, stable public v1 exports, clean-directory installation, installed CLI and Workbench startup, consumer-authored external Harness execution through both entries, Workbench form creation, same-Adapter isolated Execution Fork, verified Receipts, and store schema v1 to v2 migration without changing the retained Mission event | [Iteration 10 package smoke](https://github.com/Oxygen56/missionbraid/blob/main/evidence/iteration-10-package-smoke-local-2026-08-26.json)                                                          | Internal clean-install run; no npm publication or independent operator                                                   |
...
Outcome Studio and later evaluation surfaces are present in the source tree,
but this candidate does not promote them to a stronger runtime claim without a
separate retained record. See the [evidence index](../evidence/README.md) for
...
8. opens a schema-v1 store with the installed Workbench, migrates it to schema
