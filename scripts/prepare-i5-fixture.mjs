...
const template = join(repositoryRoot, 'examples', 'i5-execution-fork-fixture', 'template');
...
run('git', [
  ...
  'commit',
  '-qm',
  'controlled Iteration 5 fixture',
]);
...
if (baseline.status === 0) throw new Error('Iteration 5 fixture unexpectedly passes.');
